...
let locations = [
    { name: 'Clinic 1 (Orthopaedic)', coordinates: [-45.139036, -178.59375] },
    { name: 'Clinic 1a - lvl3 (Immunology)', coordinates: [33.137551, -120.234375] },
    { name: 'Clinic 2 (Rheumatology/ECG)', coordinates: [21.893046, -180.703125] },
    { name: 'Clinic 2a (Allergy/Lung)', coordinates: [22.543726, -151.171875] },
    { name: 'Clinic 3 - lvl3 (Opthalmology/Eye)', coordinates: [-13.239945, -180] },
    { name: 'Clinic 4 - lvl3 (Surgery/GI)', coordinates: [-13.239945, -180] },
    { name: 'Clinic 4a - lvl3 (Ultrasound)', coordinates: [-13.239945, -180] },
    { name: 'Clinic 5 (Ambulatory)', coordinates: [-37.210317, -266.484375] },
    { name: 'Clinic 6 (Paediatric)', coordinates: [23.191346, -321.328125] },
    { name: 'Clinic 7 - lvl 3 (Skin)', coordinates: [-23.885838, -284.765625] },
    { name: 'Clinic 8 - lvl 3 (Oral)', coordinates: [-12.554564, -334.6875] },
    { name: 'Clinic 9 (UTC)', coordinates: [-56.609482, -266.484375] },
    { name: 'Clinic 10 (ENT/Audiology)', coordinates: [18.646245, -206.015625] },
    { name: 'Clinic 12 - lvl3 (GI/Renal)', coordinates: [-13.239945, -180] },
    ...
    { name: 'Blood Tests', coordinates: [-42.082974, -309.375] },
    ...
    { name: 'Cleft Lip and Palatte - lvl3', coordinates: [-23.885838, -284.765625] },
    ...
    { name: 'DEXA - lvl3', coordinates: [-17.308688, -177.890625] },
    ...
    { name: 'Haematology Day Unit', coordinates: [-83.829945, 111.09375] },
    ...
    { name: 'MRIs', coordinates: [80.297927, 51.328125] },
    { name: 'NCCU', coordinates: [-10.487812, -63.984375] },
    { name: 'Neonatal Unit - lvl3', coordinates: [60.239811, 243.984375] },
